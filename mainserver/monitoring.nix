...
in 
{
  ...
  environment.etc = let
    dashboard-builder = src: pkgs.stdenv.mkDerivation {
    ...
    grafana-dashboards = {
      ...
      "grafana-dashboards/unbound.json" = dashboard-builder (pkgs.fetchzip {
      ...
      "grafana-dashboards/caddy.json" = dashboard-builder (pkgs.fetchurl {
